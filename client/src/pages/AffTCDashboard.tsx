  ...
  const exportToExcel = async () => {
    ...
    try {
      ...
      for (const aff of topAffsByRevenue) {
        try {
          // Fetch all orders for this AFF TC
          ...
          console.error(`[AFF TC] Error fetching orders for ${aff.name}:`, err);
        }
      }
      ...
      alert(`Đã xuất báo cáo với ${topAffsByRevenue.length} AFF TC chi tiết!`);
    } catch (error) {
