...
function App() {
  // Navigation state - Thêm lại cho Finance
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-800">
                  TikTok Shop {activeTab === 'dashboard' ? 'Dashboard' : 'Finance'}
                </h1>
                <p className="text-sm text-gray-500">
                  {activeTab === 'dashboard' ? 'Quản lý đơn hàng thông minh' : 'Báo cáo tài chính chi tiết'}
                </p>
              </div>
